<script>
  ...
  let reviewsSlice = reviews.slice(0, 3);
...
<div class="reviews__holder">
  ...
  <div class="more__reviews">
    ...
    {:else}
      ...
      <svg
        on:click={() => {
          reviewsSlice = reviews.slice(0, 3);
          toogleButton = !toogleButton;
        }}
...
<style>
  ...
  .cont {
    ...
    /* grid-auto-columns: min(90vw, 1000px); */
    /* grid-template-columns: auto; */
    /* grid-template-columns: repeat(auto-fill, min(90vw, 600px)); */
    /* column-gap: 2vw; */
    row-gap: 3vh;
    /* left: 0; */
  }
