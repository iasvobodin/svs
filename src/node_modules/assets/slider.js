...
class WebGLSlider extends Slider {
  ...
  setupPlanes() {
    ...
    for (let i = 0; i < planeElements.length; i++) {
      ...
      const plane = this.curtains.addPlane(planeElements[i], params)
  ...
  setupShaderPass() {
    ...
    if (this.shaderPass) {
      ...
      this.shaderPass.onRender(function () {
        ...
        const secondaryDirection = self.direction === 0 ? 1 : 0
        self.shaderPass.uniforms.offset.value[secondaryDirection] =
          self.shaderPass.uniforms.offset.value[secondaryDirection] + 1
      })
    }
  }
  ...
  updateMousePosUniform(mousePosition) {
    ...
    if (this.shaderPass) {
      ...
      const relativeMousePos = this.shaderPass.mouseToPlaneCoords(
        mousePosition[0],
        mousePosition[1]
      )
  ...
  onDragEnded(mousePosition) {
    ...
    let duration = 100 / this.options.easing
    let easing = 'linear'
